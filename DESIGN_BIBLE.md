...
Future construction, room expansion, damage, sealing, ventilation, drainage, power, and creature movement should extend this physical map and work-order model. Detailed room interaction starts from map selection and contextual commands rather than always-visible room cards; room stockpiles, station records, policies, tasks, and historical logs live in their management menus. This construction-order pass does not yet model excavation materials, recovered deconstruction materials, money, noise, secrecy, additional workers, supports, or buildable infrastructure; those should layer onto persistent tile orders and physical terrain rather than replacing them.
