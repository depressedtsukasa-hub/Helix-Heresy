...
1. Map-Centered Selection Inspector
2. Contextual Command Menu
3. Management Menus and Top-Level Navigation
4. Creature Records Menu
5. Task and Queue Management Menu
6. Inventory, Resources, and Room Stockpile Menus
7. Policies, Automation, and Debug Menus
8. Message History and Alert Feed
9. Map Overlay and Legend Menu
10. Remove Persistent Prototype Panels
11. Keyboard Navigation and Menu Flow Polish
