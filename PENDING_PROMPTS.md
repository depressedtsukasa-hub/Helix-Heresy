...
1. Workstations, Bills, Recipes, and Crafting Orders
2. Tile-Level Environmental Fields and Diffusion
3. Ventilation, Drainage, Heating, Lighting, and Mana Infrastructure
4. Visibility, Sound, Scent, and Creature Perception
5. Door Permissions, Restricted Zones, and Creature Access Policies
6. Scalable Pathfinding, Space Sharing, and Movement Reservations
7. Slime Need Priorities, Intent Switching, and Interrupted Actions
8. Creature Job Autonomy and Physical Workplace Interaction
9. Containment Breach Response, Recapture, and Emergency Lockdown
10. Cleaning, Hauling, Maintenance, and Repair Work
11. Tactical Combat Movement, Abilities, and Map Commands
12. Simulation Scheduling and Performance for Hundreds of Actors
